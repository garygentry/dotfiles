...
link_file "docs/README.md" "overview"
link_file "docs/installation.md" "installation"
link_file "docs/quick-start.md" "quick-start"
link_file "docs/content-overlay.md" "content-overlay"
link_file "docs/extending.md" "extending"
link_file "docs/creating-modules.md" "creating-modules"
link_file "docs/rollback-guide.md" "rollback-guide"
link_file "docs/troubleshooting.md" "troubleshooting"
link_file "docs/ci-cd-guide.md" "ci-cd-guide"
link_file "docs/cli-reference.md" "cli-reference"
link_file "docs/architecture.md" "architecture"
link_file "docs/idempotence.md" "idempotence"
link_file "docs/design-rationale.md" "design-rationale"
link_file "docs/ux-features.md" "ux-features"
